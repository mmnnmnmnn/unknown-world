...
const SCENE23_TIMELINE = {
  // Scene1 -> Scene2 crossfade를 더 길고 천천히
  scene1ToMilkywayEnd: 2200,

  // crossfade가 길어진 만큼 이후 구간 전체를 뒤로 이동
  milkywayHoldEnd: 5200,
  milkywayZoomEnd: 8500,

  closeupFadeStart: 6700,
  closeupReady: 8500,
  closeupHoldEnd: 10000,

  clusterMatchStart: 10000,
  clusterMatchEnd: 11100,

  // Scene 3에서는 중앙 이동과 Zoom Out이 동시에 일어나도록
  clusterZoomOutStart: 10000,
  clusterZoomOutEnd: 13800,

  // 마지막 도착 화면도 동일하게 유지
  scene3ArrivalHoldEnd: 15800
};
...
function renderScene23(time) {
  ...
  /* -----------------------------------------------------
     2. Milky Way
     시작 상태부터 좌측 하단 anchor로 1.15배 확대
     그 상태를 유지하다가 특정 영역으로 Zoom In
  ----------------------------------------------------- */
  let milkyZoom = 1;
  let milkyX = 50;
  let milkyY = 50;

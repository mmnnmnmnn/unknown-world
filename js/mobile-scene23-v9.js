...
const SCENE23_TIMELINE = {
  ...
  closeupRotateEnd: 11450,

  // 회전이 멈춘 뒤 더 천천히 사라짐
  closeupFadeOutStart: 11450,
  closeupFadeOutEnd: 13450,

  // 은하단 이미지는 같은 위치에서 아래에 나타나며 match
  clusterFadeStart: 11200,
  clusterFadeEnd: 13450,

  // closeup이 완전히 사라진 뒤에만
  // 중앙 이동 + Zoom Out 시작
  clusterZoomOutStart: 13450,
  clusterZoomOutEnd: 17250,

  // Scene 3 도착 후 유지
  scene3ArrivalHoldEnd: 19250
};
...
function renderScene23(time) {
  ...
  /* -----------------------------------------------------
     ...
     A) 11.2~11.45초: 0.25초만 회전
     B) 11.45초 이후: 회전 정지
     C) 11.45~13.45초: 회전한 상태 그대로 더 천천히 fade out
  ----------------------------------------------------- */
  ...
  // 겹치는 형태를 유지하면서 회전 시간을 0.25초로 늘림.
  // 약 1도 정도에서 정지.

...
const SCENE23_TIMELINE = {
  ...
  // 회전이 끝난 직후 바로 은하단으로 전환되도록 짧게 페이드아웃
  closeupFadeOutStart: 10450,
  closeupFadeOutEnd: 10850,

  // 은하단 이미지는 회전 종료 시점부터 즉시 나타나며 match
  clusterFadeStart: 10450,
  clusterFadeEnd: 10850,

  // closeup이 사라진 직후 Zoom Out 시작
  clusterZoomOutStart: 10850,

  // 줌아웃 시작 후 0.5초 뒤 중앙 이동 시작
  clusterPanStart: 11350,
  clusterZoomOutEnd: 13383,

  // Scene 3 완료 텍스트
  scene3TitleStart: 13733,
  scene3TitleReady: 14483,

  // Scene 4 직전 장면 유지
  preScene4HoldEnd: 17883
};
...
function renderScene23(time) {
  ...
  /* -----------------------------------------------------
     5. Cluster layer
     - 회전 종료 시점부터 바로 같은 자리에 나타나 match
  ----------------------------------------------------- */
